...
- (NSString *)uploading
{
	...
	[postParam setObject:imageData forKey:@"head"];
	
	NSData *postData = [self generateFormDataFromPostParam:postParam];
    NSString *postLength = [NSString stringWithFormat:@"%d", postData.length];
    //
    //    NSString *urlString = @"http://192.168.21.190/FirstPlace/PhotoNotes.asmx/UploadData";
    //    NSString *urlString = @"http://10.180.13.101/ipad.web/Controllers/PhotoNotes.asmx/UploadData";
    NSString *urlString = @"http://10.180.13.101/ipad.web/test/uploadHead?";
    //    NSString *urlString = @"http://10.180.13.101/ipad.web/test/test?";
